/***************************************************************************************************       
Asset:        Zero to Snowflake - シンプルなデータパイプライン (Part 1)
Version:      v2     
Copyright(c): 2025 Snowflake Inc. All rights reserved.
****************************************************************************************************

シンプルなデータパイプライン (Part 1)
1. 外部ステージからのデータ取り込み
...
続き（オプション）:
  この後は vignette-2-2.md（CoCo in Snowsight でパイプラインを作ってみる）に
  進んでください。
...
/* 4. ダイナミックテーブルによるシンプルなパイプライン
    ...
    他のダイナミックテーブルを参照するダイナミックテーブルを作成することで、
    マルチステップパイプライン（有向非巡回グラフ＝DAG）を構築できます。
    ソースに変更があると、更新が下流のダイナミックテーブルへ自動的に伝播します。
*/
